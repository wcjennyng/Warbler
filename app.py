...
def add_user_to_g():
    ...
    #g is a global namespace for holding any data during a single app
    #before_request handler sets g.user which makes it accessible to route and functions
...
def add_like(message_id):
    """Like/un-like message for currently logged in user"""
...
def homepage():
    ...
    if g.user:
        ...
        user_following = [f.id for f in g.user.following] + [g.user.id]
